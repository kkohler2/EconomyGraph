...
namespace EconomyGraph.Views.ContentViews
{
    ...
    public partial class StepGraphView : ContentView
    {
        #region Bindings
        public static readonly BindableProperty GraphWidthProperty =
            BindableProperty.Create("GraphWidth", typeof(double), typeof(StepGraphView), null, BindingMode.OneTime);

        public static readonly BindableProperty GraphHeightProperty =
            BindableProperty.Create("GraphHeight", typeof(double), typeof(StepGraphView), null, BindingMode.OneTime);

        public static readonly BindableProperty ViewModelProperty =
            BindableProperty.Create("ViewModel", typeof(StepGraphViewModel), typeof(StepGraphView), null, BindingMode.OneTime);
        ...
        public StepGraphViewModel ViewModel
        {
            get { return (StepGraphViewModel)GetValue(ViewModelProperty); }
            set { SetValue(GraphHeightProperty, value); }
        }
        #endregion

        readonly GraphEngine graphEngine;
        public StepGraphView()
        {
