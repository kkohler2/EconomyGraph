...
namespace EconomyGraph.Views.ContentViews
{
    ...
    public partial class ShadedStepGraphView : StepGraphView
    {
        public ShadedStepGraphView()
        {
            InitializeComponent();
        }
        ...
        {
            ShadedStepGraphViewModel viewModel = ViewModel as ShadedStepGraphViewModel;
