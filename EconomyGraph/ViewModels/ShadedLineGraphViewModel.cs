        ...
        public ShadedLineGraphViewModel()
        {
            ...
            ShadePeriods = new List<ShadePeriod>
            {
                new ShadePeriod
                {
                    ...
                    EndDate = new DateTime(1933,3,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1937,5,1),
                    EndDate = new DateTime(1938,6,30)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1945,2,1),
                    EndDate = new DateTime(1945,10,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1948,10,1),
                    EndDate = new DateTime(1949,10,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1953,7,1),
                    EndDate = new DateTime(1954,5,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1957,8,1),
                    EndDate = new DateTime(1958,4,30)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1960,4,1),
                    EndDate = new DateTime(1961,2,28)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1969,12,1),
                    EndDate = new DateTime(1970,10,30)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1973,11,1),
                    EndDate = new DateTime(1975,3,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1980,1,1),
                    EndDate = new DateTime(1980,7,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1981,7,1),
                    EndDate = new DateTime(1982,11,30)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(1990,7,1),
                    EndDate = new DateTime(1991,3,31)
                },
                new ShadePeriod
                {
                    StartDate = new DateTime(2001,3,1),
                    EndDate = new DateTime(2001,11,30)
                },
                new ShadePeriod
                {
